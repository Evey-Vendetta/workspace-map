...
STOP_WORDS = {
    ...
    "of", "with", "is", "it", "be", "as", "at", "this", "that", "was",
    "are", "were", "been", "have", "has", "had", "do", "does", "did",
    "will", "would", "could", "should", "may", "might", "can", "shall",
    "not", "no", "so", "if", "by", "from", "up", "out", "about", "into",
    "then", "than", "also", "just", "its", "it's", "i", "we", "you", "he",
    "she", "they", "my", "your", "our", "their", "what", "which", "who",
    "how", "when", "where", "all", "any", "each", "more", "some", "there",
    "these", "those", "new", "one", "two", "three", "get", "got", "let",
    "want", "need", "make", "made", "see", "look", "like", "going", "go",
    "now", "here", "s", "re", "ve", "ll", "t", "m", "d",
    "tool", "bash", "file", "please", "using", "would", "claude", "code",
    "run", "write", "add", "help", "create", "check", "update", "read",
    "note", "message", "result", "response", "output", "input", "yes",
    "sure", "okay", "ok", "hi", "hello", "thanks", "thank", "done",
    "good", "great", "right", "think", "know", "try", "use", "used",
    "work", "works", "working", "error", "fix", "build", "change",
    "changes", "following", "current", "first", "last",
    "next", "back", "into", "after", "before", "need", "take", "give",
    "instead", "way", "much", "well", "still", "even", "both", "while",
    "through", "between", "should", "actually", "already", "also",
    "something", "everything", "nothing", "anything", "looks", "seems",
}
...
def extract_keywords(text: str, extra: str = "", max_kw: int = 8,
                     synonyms: dict | None = None) -> list:
